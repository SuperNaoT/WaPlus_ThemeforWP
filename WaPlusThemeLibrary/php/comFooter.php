  ...
  <!-- ＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃＃ -->
    ...
    <footer>
          ...
          <div class="footerLogo">
            <a href="<?php echo esc_url( home_url('/') ); ?>">
              <?php if( ! has_custom_logo() ):?>
                <img src="<?php echo esc_url( get_template_directory_uri().'/wp-config/Images/WaPlus-Logo.png' ) ?>" alt="株式会社和Plus・和プラス・ワプラスのロゴマークが入った画像">
              <?php else: ?>
                <?php
                  // 
      ...
      <!-- <div class="w3cValidation">
        <a href="<?php echo esc_url( get_template_directory_uri().'/wp-config/w3cValidation/w3cValidate.html' ); ?>" target="_blank" rel="noopener noreferrer">
          <img style="width:88px;height:31px"
                src="<?php echo esc_url( get_template_directory_uri().'/wp-config/w3cValidation/images/vcss.gif' ); ?>"
